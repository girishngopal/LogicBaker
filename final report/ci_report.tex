...
, 2007. 
\bibitem{r1} Magennis, Troy, \quotes{Continuous Integration and Automated Builds at Enterprise Scale}, \textit{ Online posting} 2007 
\bibitem{r2}The Zend Blueprint for Continuous Delivery, Zend Technologies, www.zend.com/continuousdelivery.
\bibitem{r3} Adopting the IBM DevOps approach for
continuous software delivery,
http://www.ibm.com/developerworks/libr
ary/d-adoption-paths/ .
\bibitem{r3} \textit{Understanding DevOps – Infrastructure as
a Code, https://sdarchitect.wordpress.com/2012/12
