...
\
\section{Hardware Requirements}   //jefine fill cheytho
...
% Keyboard\hspace{.56in}:\hspace{.54in}Standard\\
 ...
 \pagebreak
\section{Network Requirements}  // jefinee fill cheytho
\begin{itemize}
...
\includegraphics[scale=0.53]{LogicBakerGantt.pdf}
\caption{Gantt Chart}
\end{center}
\end{figure}
