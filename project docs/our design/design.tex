...
\vspace{2 in}
\hspace{1 in}
\epsfig{width=8in, file=dfd0.jpg}
\caption{Level 0 DFD}
\end{center}
\end{figure}
\pagebreak
...
\vspace{2 in}
\hspace{1 in}
\epsfig{width=8in, file=dfd1_1.jpg}
...
\vspace{2 in}
\hspace{.0 in}
\epsfig{width=6in, file=dfd2_1_1.jpg}
...
\begin{figure}[h]
\begin{center}
\epsfig{width=5in, file=dfd2_1_2.jpg}
...
\begin{figure}[h]
\begin{center}
\epsfig{width=5in, file=dfd2_1_3.jpg}
...
\begin{figure}[h]
\begin{center}
\epsfig{width=5in, file=dfd2_1_4.jpg}
