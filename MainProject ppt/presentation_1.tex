...
\vspace{0.5cm}
\begin{itemize}
\item Deploy a web project to a staging server.
\vspace{0.5cm}
\item Deploy latest stable build of a desktop application.
\end{itemize}
\end{itemize}
\end{frame} 
...
\begin{itemize}
	\item For demonstration to the Tech 11 Software Team, We decided to implement a Calculator application (using Java, javaScript, NodeJs, Angularjs)
	\item We divided the work
	\\
	\begin{itemize}
...
\begin{frame}{Implementation}
	...
	\begin{itemize}
		...
		\item Created modules given to each member in java
...
\begin{frame}{Implementation}
	\textbf{Artifact Repository}
	\begin{itemize}
		\item The Difficulty in integrating the individual modules due to the syntax mis-matching is overcome by 
...
\begin{frame}{Implementation}
	...
	\begin{itemize}
		...
		\item The Same Calculator Test application code is mavenised by each team member and again pushed to the local repository.
		\vspace{0.05cm}
		\item The whole application can be integrated and build in each team members local system much \underline{easier}. 
		\vspace{0.05cm}
...
\begin{frame}{Implementation}
	...
	\begin{itemize}
		...
		\vspace{0.05cm}
		\item Thats the idea behind Continuous Integration, We provide a Automation platform where all team members and the project manager can VIEW the application and discuss.
...
\begin{frame}{Implementation}
	\textbf{Continuous Integration Handler}
	\begin{itemize}
...
\begin{frame}{Implementation}
	...
	\begin{itemize}
		...
		\item The test Automation plugin is added to Jenkins depending upon the nature of the development process dealing with.
		\vspace{0.05cm}
		...
		\vspace{0.05cm}
		\item Also added Jacoco , For code coverage.
...
\begin{frame}{Implementation}
	...
	\begin{itemize}
		...
		\item The same mavenised java application is pushed to heroku Git hub.
		\item Also code the same application in Node.js for efficient viweing, and deployed
