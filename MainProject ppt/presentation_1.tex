...
\begin{frame}{Implementation}
	...
	\begin{itemize}
		\item Created a Repository naming LogicBaker in Git-Hub and cloned to individual system.
		\item Create each members given modules in local system in Java.
		\item After Coding the individual modules the team members commit to Git-Hub.
		\item Irrespective on the platform which each one has build.
...
\begin{frame}{Implementation}
	\textbf{Artifact Repository}
	\begin{itemize}
		\item The Difficulty in integrating the individual modules due to the syntax mis-matching is overcomes by 
...
\begin{frame}{Implementation}
	...
	\begin{itemize}
		\item The Difficulty in integrating the individual modules due to the syntax mis-matching is overcomes by 
		\underline{Maven}ising the Individual modules.
